...
const TripView = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50">
            ...
            {/* Bottom Navigation */}
            <nav className="bg-white border-t border-gray-100 flex justify-around items-center h-[3.5rem] shrink-0 pb-safe z-30 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.02)]">
                <NavLink
                    to="schedule"
                    className={({ isActive }) =>
                        clsx(
